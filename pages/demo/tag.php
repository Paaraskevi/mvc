        ...
        <div class="row">
                            ...
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="#"> <img src="<?= configController::getImagePath($contents[0]->image,600,800) ?>" alt="Article Image" alt="image"></a>
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <div class="stay-connected-ads">
                    ...
                    <a href="#"><img src="<?= configController::getImagePath($content[0]->image,600,800) ?>" />
                ...
                <div class="featured-news">
                    ...
                    ?>
                        <div class="single-featured-news">
                            <a href="#"> <img src="<?= configController::getImagePath($contents[0]->image) ?>" alt="Article Image" class="img-fuild"></a>
                            <div class="news-content">
                                <ul>
                                    <li><i class="icofont-user-suited"></i> by <a href="#"></a></li>
                    ...
                    ?>
                            <div class="col-lg-12 col-md-12">
                                <div class="single-more-news">
                                    <img src="<?= configController::getImagePath($content[0]->imag,600,800) ?>" alt="image">

                                    <div class="news-content">
                                        <ul>
                                            <li><i class="icofont-user-suited"></i> by <a href="#"><?= $article->auhtorname ?></a></li>
                                            <li><i class="icofont-calendar"></i> <?= $article->cdatetime ?></li>
                                        </ul>
                                        <h3><a href="#"><?= $article->descriptionn ?></a></h3>
                                    </div>
                                    <div class="tags <?= $article->category_name ?>">
                                        <a href="#"><?= $article->category_name ?></a>
                                    </div>
                                </div>
                            </div>
...
<a href="/tags/<?= $contents[0]->category_name ?>/page<?= $page - 1 ?>" class="prev page-numbers"><i class="icofont-double-left"></i></a>
    <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
        <a href="/tags/<?= $contents[0]->category_name ?>/page<?= $i ?>" class="page-numbers <?= $i === $page ? 'current' : '' ?>" onclick="showPage(<?= $i ?>, <?= $category_id ?>)"><?= $i; ?></a>
    <?php endfor; ?>
    <a href="/tags/<?= $contents[0]->category_name ?>/page<?= $page + 1 ?>" class="next page-numbers"><i class="icofont-double-right"></i></a>
</div>
<?php if ($page > 1) : ?>
    <a class="prev page-numbers" href="/tags/<?= $contents[0]->category_name ?>/page<?= $page - 1 ?>" onclick="showPage(<?= $page - 1 ?>, <?= $category_id ?>)"></a>
<?php endif; ?>

<?php if ($page < $total_pages) : ?>
    <a class="next page-numbers" href="/tags/<?= $contents[0]->category_name ?>/page<?= $page + 1 ?>" onclick="showPage(<?= $page + 1 ?>, <?= $category_id ?>)"></a>
<?php endif; ?>
</div>
