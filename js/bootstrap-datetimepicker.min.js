 ...
 */
      function updateinput(date) {
           date = (typeof date !== 'undefined') ?  date : $("input.form-control.date-time").val();
          


        var newartdate = date ;
          //(year, month, day, hours, minutes, seconds, milliseconds);  05/08/2017 11:44:23

        var iso8601 = newartdate;
        
        
          
          newartdate = newartdate.replace(/\//g,",");
          newartdate =newartdate.replace(/\:/g,",");
           newartdate = newartdate.replace(/\ /g,",");
          var dateArr = newartdate.split(",");
          console.log(dateArr);
            ...
            var userDate = new Date(dateArr[2],(dateArr[1] - 1),dateArr[0],dateArr[3],dateArr[4],dateArr[5]);
             userDatesec = Date.parse( userDate);
        ...
        if (userDatesec >= today && iso8601.length >= 8 && userDate != NaN) {
